...
public class L1CostCalculator {
    ...
    public Wei l1Cost(
        ...
        if (!this.genesisConfigOptions.isEcotone(blockHeader.getTimestamp())) {
            ...
            if (genesisConfigOptions.isFjord(blockHeader.getTimestamp())) {
                return l1CostFjord(rollupGasData, l1BaseFee, l1BlobBaseFee, l1BaseFeeScalar, l1BlobBaseFeeScalar);
            }
            return l1CostInEcotone(rollupGasData, l1BaseFee, l1BlobBaseFee, l1BaseFeeScalar, l1BlobBaseFeeScalar);
        }
    }
    ...
    private Wei l1CostInBedrock(
        ...
        return l1CostInBedrockProcess(
                rollupGasData, l1BaseFee, overhead, l1FeeScalar, isRegolith);
    }
    ...
    private Wei l1CostInEcotone(
        ...
        var calldataGas =
                costData.zeroes() * TX_DATA_ZERO_COST
                        + costData.ones() * TX_DATA_NON_ZERO_GAS_EIP2028_COST;
